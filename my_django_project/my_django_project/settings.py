...
# SECRET_KEY = 'django-insecure-dzepx22m&cb9t)q6oyz)#=l-78hwm(^2imx+w^9c&meahlndj&'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'natniks$default',
        'USER': 'natniks',
        'PASSWORD': os.getenv('MYSQL_PASSWORD'),
        'HOST': 'natniks.mysql.pythonanywhere-services.com',
        'OPTIONS': {
